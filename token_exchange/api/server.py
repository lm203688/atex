        ...
        # ── 部署接口（仅限内网/认证调用）──
            ...
            if action == "pull_and_restart":
                ...
                try:
                    ...
                    r1 = subprocess.run(["curl", "-L", "https://ghproxy.com/https://github.com/lm203688/atex/archive/refs/heads/main.tar.gz", "-o", "/tmp/atex_latest.tar.gz"], capture_output=True, timeout=120)
